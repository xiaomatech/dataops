...
wget http://repo1.maven.org/maven2/org/apache/hudi/hudi-timeline-server-bundle/0.5.0-incubating/hudi-timeline-server-bundle-0.5.0-incubating.jar -P  $base_dir/hudi/
wget http://repo1.maven.org/maven2/org/apache/hudi/hudi-presto-bundle/0.5.0-incubating/hudi-presto-bundle-0.5.0-incubating.jar -P  $base_dir/hudi/
wget http://repo1.maven.org/maven2/org/apache/hudi/hudi-hive-bundle/0.5.0-incubating/hudi-hive-bundle-0.5.0-incubating.jar -P  $base_dir/hudi/
wget http://repo1.maven.org/maven2/org/apache/hudi/hudi-hadoop-mr-bundle/0.5.0-incubating/hudi-hadoop-mr-bundle-0.5.0-incubating.jar -P  $base_dir/hudi/
wget http://repo1.maven.org/maven2/org/apache/hudi/hudi-spark-bundle/0.5.0-incubating/hudi-spark-bundle-0.5.0-incubating.jar -P  $base_dir/hudi/

wget http://repo1.maven.org/maven2/io/delta/delta-core_2.11/0.5.0/delta-core_2.11-0.5.0.jar -P $base_dir/spark/