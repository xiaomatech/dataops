...
__all__ = [
    "has_atlas_in_cluster", "setup_atlas_hook", "setup_atlas_jar_symlinks"
]
...
def setup_atlas_hook(service_name, service_props, atlas_hook_filepath, owner,
                     group):
    """
    ...
    install_atlas_hook(service_name.lower())
    ...
    Logger.info(
        format("Generating Atlas Hook config file {atlas_hook_filepath}"))
    PropertiesFile(
        atlas_hook_filepath,
