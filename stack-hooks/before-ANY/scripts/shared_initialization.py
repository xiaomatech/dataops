...
def setup_users():
  ...
  """
    ...
    should_create_users_and_groups = True
    ...
    if should_create_users_and_groups:
        ...
        if params.has_tez and params.stack_version_formatted != "" and compare_versions(
                params.stack_version_formatted, '2.3') >= 0:
...
def setup_java():
  ...
  """
    import params
    __setup_java(
        custom_java_home=params.java_home, custom_jdk_name=params.jdk_name)
