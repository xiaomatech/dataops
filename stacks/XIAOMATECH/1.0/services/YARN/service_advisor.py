...
class YARNRecommender(service_advisor.ServiceAdvisor):
  ...
  """
    ...
    def recommendYARNConfigurationsFromHDP206(self, configurations,
                                              clusterData, services, hosts):
        """
    ...
    """
        ...
        yarn_mount_properties = [
            ("yarn.timeline-service.leveldb-timeline-store.path",
             "APP_TIMELINE_SERVER", "/data1/hadoop/yarn/timeline", "single"),
        ...
        if "TEZ" in servicesList:
            ...
            putYarnProperty(
                "yarn.timeline-service.http-authentication.proxyuser.{0}.hosts"
                    .format(ambari_user), ambariHostName)
            putYarnProperty(
                "yarn.timeline-service.http-authentication.proxyuser.{0}.groups"
                    .format(ambari_user), "*")
            old_ambari_user = self.getOldAmbariUser(services)
            if old_ambari_user is not None:
                putYarnPropertyAttribute(
                    "yarn.timeline-service.http-authentication.proxyuser.{0}.hosts"
                        .format(old_ambari_user), 'delete', 'true')
                putYarnPropertyAttribute(
                    "yarn.timeline-service.http-authentication.proxyuser.{0}.groups"
                        .format(old_ambari_user), 'delete', 'true')

    def recommendYARNConfigurationsFromHDP22(self, configurations, clusterData,
                                             services, hosts):
        ...
        putYarnEnvProperty = self.putProperty(configurations, "yarn-env",
                                              services)
        putCapScheProperty = self.putProperty(configurations,
                                              "capacity-scheduler", services)
        putYarnProperty('yarn.scheduler.minimum-allocation-vcores', 1)
        putYarnProperty('yarn.scheduler.maximum-allocation-vcores',int(clusterData['cpu'])*2)
        # Property Attributes
        putYarnPropertyAttribute = self.putPropertyAttribute(
            configurations, "yarn-site")
        ...
        if (nodeManagerHost is not None):
            ...
            putYarnProperty(
                'yarn.scheduler.maximum-allocation-vcores',str(cpuLimit*2))
            # putYarnPropertyAttribute('yarn.nodemanager.resource.memory-mb',
            #                          'maximum',
            #                          int(nodeManagerHost["Hosts"]["total_mem"]
            ...
            if yarn_cgroups_enabled or self.has_multiple_resource_types(
                ...
                if not received_as_key_value_pair:
                    ...
                    putCapScheProperty("capacity-scheduler",
                                       updated_cap_sched_configs_str)
                    self.logger.info(
    ...
    def recommendYARNConfigurationsFromHDP23(self, configurations, clusterData,
                                             services, hosts):
        ...
        if "ranger-env" in services["configurations"] and "ranger-yarn-plugin-properties" in services[
            ...
            rangerEnvYarnPluginProperty = services["configurations"][
                "ranger-env"]["properties"]["ranger-yarn-plugin-enabled"]
            putYarnRangerPluginProperty("ranger-yarn-plugin-enabled",
                                        rangerEnvYarnPluginProperty)
        rangerPluginEnabled = ''
        if 'ranger-yarn-plugin-properties' in configurations and 'ranger-yarn-plugin-enabled' in configurations[
            'ranger-yarn-plugin-properties']['properties']:
            rangerPluginEnabled = configurations[
                'ranger-yarn-plugin-properties']['properties'][
                'ranger-yarn-plugin-enabled']
        elif 'ranger-yarn-plugin-properties' in services[
            'configurations'] and 'ranger-yarn-plugin-enabled' in services[
        ...
        if rangerPluginEnabled and (
            ...
            putYarnSitePropertyAttributes('yarn.authorization-provider',
                                          'delete', 'true')

    def recommendYARNConfigurationsFromHDP25(self, configurations, clusterData,
                                             services, hosts):
    ...
    def recommendYARNConfigurationsFromHDP26(self, configurations, clusterData,
        ...
        putYarnEnvProperty = self.putProperty(configurations, "yarn-env",
                                              services)
        putResTypsProperty = self.putProperty(configurations, "resource-types",
                                              services)
        putCapScheProperty = self.putProperty(configurations,
                                              "capacity-scheduler", services)
        putCanExecProperty = self.putProperty(configurations,
        ...
        if 'yarn-env' in services['configurations'] and 'yarn_user' in services[
        ...
        if 'ranger-yarn-plugin-properties' in configurations and 'ranger-yarn-plugin-enabled' in configurations[
            ...
            ranger_yarn_plugin_enabled = (
                    ...
                    ['ranger-yarn-plugin-enabled'].lower() == 'Yes'.lower())
        elif 'ranger-yarn-plugin-properties' in services[
            'configurations'] and 'ranger-yarn-plugin-enabled' in services[
            'configurations']['ranger-yarn-plugin-properties'][
            'properties']:
            ranger_yarn_plugin_enabled = (
                    ...
                    ['properties']['ranger-yarn-plugin-enabled'].lower() == 'Yes'.
                    lower())
        else:
        ...
        if "yarn-site" in services["configurations"] and \
            ...
            webservice_url = ''
            if services["configurations"]["yarn-site"]["properties"][
                "yarn.http.policy"] == 'HTTP_ONLY':
                if "yarn.timeline-service.webapp.address" in services[
                    "configurations"]["yarn-site"]["properties"]:
                ...
                if "yarn.timeline-service.webapp.https.address" in services[
                    "configurations"]["yarn-site"]["properties"]:
                    webapp_address = services["configurations"]["yarn-site"][
                        "properties"][
            ...
            putYarnSiteProperty('yarn.log.server.web-service.url',
                                webservice_url)

        if ranger_yarn_plugin_enabled and 'ranger-yarn-plugin-properties' in services[
            ...
            putRangerYarnPluginProperty = self.putProperty(
                configurations, "ranger-yarn-plugin-properties", services)
            putRangerYarnPluginProperty("REPOSITORY_CONFIG_USERNAME",
                                        yarn_user)
        else:
        ...
        if yarn_timeline_app_cache_size is not None:
            ...
            putYarnEnvProperty('apptimelineserver_heapsize',
                               ats_heapsize)  # Value in MB
            self.logger.info(
                "Updated YARN config 'apptimelineserver_heapsize' as : {0}, ".
                    format(ats_heapsize))
        ...
        if "resource-types" in services["configurations"] and \
            ...
            yarn_restyps = services["configurations"]["resource-types"][
                "properties"]["yarn.resource-types"]
            restyps_list = yarn_restyps.split(
                ',') if len(yarn_restyps) > 1 else yarn_restyps.split()
            self.logger.info(
                "new what is yarn_restyps: '{0}'.".format(restyps_list))

        if "yarn-env" in services["configurations"] and \
                "yarn_cgroups_enabled" in services["configurations"]["yarn-env"]["properties"]:
            yn_cgrp_active = services["configurations"]["yarn-env"][
                "properties"]["yarn_cgroups_enabled"]

        if "container-executor" in services["configurations"]:
            if "gpu_module_enabled" in services["configurations"][
                "container-executor"]["properties"]:
                gpu_module_enabled = services["configurations"][
                    "container-executor"]["properties"]["gpu_module_enabled"]
            if "docker_module_enabled" in services["configurations"][
                "container-executor"]["properties"]:
                docker_module_enabled = services["configurations"][
                    "container-executor"]["properties"][
                    "docker_module_enabled"]

            if "docker_allowed_devices" in services["configurations"][
                "container-executor"]["properties"]:
                docker_allow_dev = services["configurations"][
                    "container-executor"]["properties"][
                    "docker_allowed_devices"]
                allow_dev_list = docker_allow_dev.split(',') if len(
                    docker_allow_dev) > 1 else docker_allow_dev.split()
                self.logger.info("new what is docker_allowed_devices: '{0}'.".
                                 format(allow_dev_list))

            if "docker_allowed_volume-drivers" in services["configurations"][
                "container-executor"]["properties"]:
                docker_allow_vol_drive = services["configurations"][
                    "container-executor"]["properties"][
                    "docker_allowed_volume-drivers"]
                allow_vol_drive_list = docker_allow_vol_drive.split(
                    ',') if len(docker_allow_vol_drive
                                ) > 1 else docker_allow_vol_drive.split()
                self.logger.info(
                    "new what is docker_allowed_volume-drivers: '{0}'.".format(
                        allow_vol_drive_list))

            if "docker_allowed_ro-mounts" in services["configurations"][
                "container-executor"]["properties"]:
                docker_allow_romounts = services["configurations"][
                    "container-executor"]["properties"][
                    "docker_allowed_ro-mounts"]
                allow_romounts_list = docker_allow_romounts.split(
                    ',') if len(docker_allow_romounts
                                ) > 1 else docker_allow_romounts.split()
                self.logger.info(
                    "new what is docker.allowed.ro-mounts: '{0}'.".format(
                        allow_romounts_list))

            if "cgroup_root" in services["configurations"][
                "container-executor"]["properties"]:
                cg_root = services["configurations"]["container-executor"][
                    "properties"]["cgroup_root"]
                cg_root_list = cg_root.split(
                    ',') if len(cg_root) > 1 else cg_root.split()

            if "yarn_hierarchy" in services["configurations"][
                "container-executor"]["properties"]:
                yn_hirch = services["configurations"]["container-executor"][
                    "properties"]["yarn_hierarchy"]
                yn_hirch_list = yn_hirch.split(
                    ',') if len(yn_hirch) > 1 else yn_hirch.split()

        if "yarn-site" in services["configurations"]:
            if "yarn.nodemanager.linux-container-executor.cgroups.hierarchy" in services[
                "configurations"]["yarn-site"]["properties"]:
                lce_cgrp_hirch = services["configurations"]["yarn-site"][
                    "properties"][
                    "yarn.nodemanager.linux-container-executor.cgroups.hierarchy"]
                lce_cgrp_hirch_list = lce_cgrp_hirch.split(',') if len(
                    lce_cgrp_hirch) > 1 else lce_cgrp_hirch.split()
                self.logger.info(
                    "new what is yarn.nodemanager.linux-container-executor.cgroups.hierarchy: '{0}'."
                        .format(lce_cgrp_hirch_list))

            if "yarn.nodemanager.linux-container-executor.cgroups.mount" in services[
                "configurations"]["yarn-site"]["properties"]:
                lce_cgrp_mt = services["configurations"]["yarn-site"][
                    "properties"][
                    "yarn.nodemanager.linux-container-executor.cgroups.mount"]

            if "yarn.nodemanager.linux-container-executor.cgroups.mount-path" in services[
                "configurations"]["yarn-site"]["properties"]:
                lce_cgrp_mtp = services["configurations"]["yarn-site"][
                    "properties"][
                    "yarn.nodemanager.linux-container-executor.cgroups.mount-path"]
                lce_cgrp_mtp_list = lce_cgrp_mtp.split(
                    ',') if len(lce_cgrp_mtp) > 1 else lce_cgrp_mtp.split()
                self.logger.info(
                    "new what is yarn.nodemanager.linux-container-executor.cgroups.mount-path: '{0}'."
                        .format(lce_cgrp_mtp_list))

            if "yarn.nodemanager.resource-plugins.gpu.allowed-gpu-devices" in services[
                "configurations"]["yarn-site"]["properties"]:
                rp_gpu_agd = services["configurations"]["yarn-site"][
                    "properties"][
                    "yarn.nodemanager.resource-plugins.gpu.allowed-gpu-devices"]
                rp_gpu_agd_list = rp_gpu_agd.split(
                    ',') if len(rp_gpu_agd) > 1 else rp_gpu_agd.split()
                self.logger.info(
                    "new what is yarn.nodemanager.resource-plugins.gpu.allowed-gpu-devices: '{0}'."
                        .format(rp_gpu_agd_list))

            if "yarn.nodemanager.resource-plugins.gpu.docker-plugin" in services[
                "configurations"]["yarn-site"]["properties"]:
                rp_gpu_dp = services["configurations"]["yarn-site"][
                    "properties"][
                    "yarn.nodemanager.resource-plugins.gpu.docker-plugin"]
                rp_gpu_dp_list = rp_gpu_dp.split(
                    ',') if len(rp_gpu_dp) > 1 else rp_gpu_dp.split()
                self.logger.info(
                    "new what is yarn.nodemanager.resource-plugins.gpu.docker-plugin: '{0}'."
                        .format(rp_gpu_dp_list))

            if "yarn.nodemanager.resource-plugins.gpu.docker-plugin.nvidiadocker-v1.endpoint" in services[
                "configurations"]["yarn-site"]["properties"]:
                ...
                rp_gpu_dp_nv1_ep_list = rp_gpu_dp_nv1_ep.split(',') if len(
                    rp_gpu_dp_nv1_ep) > 1 else rp_gpu_dp_nv1_ep.split()
                self.logger.info(
                    "new what is yarn.nodemanager.resource-plugins.gpu.docker-plugin.nvidiadocker-v1.endpoint: '{0}'."
                        .format(rp_gpu_dp_nv1_ep_list))
        ...
        if gpu_module_enabled and gpu_module_enabled.lower() == 'true':
            ...
            yarn_restyps = ','.join(str(x) for x in restyps_list)
            putYarnSiteProperty('yarn.nodemanager.resource-plugins',
                                yarn_restyps)
            ...
            if docker_module_enabled and docker_module_enabled.lower(
            ) == 'true':
                ...
                if "http://localhost:3476/v1.0/docker/cli" in rp_gpu_dp_nv1_ep_list:
                    ...
                    rp_gpu_dp_nv1_ep = ','.join(
                        str(x) for x in rp_gpu_dp_nv1_ep_list)
                    putYarnSiteProperty(
                        'yarn.nodemanager.resource-plugins.gpu.docker-plugin.nvidiadocker-v1.endpoint',
                        rp_gpu_dp_nv1_ep)
                ...
                if "regex:^/dev/nvidia.*$" in allow_dev_list:
                    ...
                    putCanExecProperty('docker_allowed_devices',
                                       docker_allow_dev)
                ...
                if 'nvidia-docker' in allow_vol_drive_list:
                    ...
                    putCanExecProperty('docker_allowed_volume-drivers',
                                       docker_allow_vol_drive)
                ...
                if "regex:^nvidia_driver_.*$" in allow_romounts_list:
                    ...
                    putCanExecProperty('docker_allowed_ro-mounts',
                                       docker_allow_romounts)
    ...
    def recommendYARNConfigurationsFromHDP30(self, configurations, clusterData,
                                             services, hosts):
        putYarnSiteProperty = self.putProperty(configurations, "yarn-site",
                                               services)
        putCapSchedProperty = self.putProperty(configurations,
                                               "capacity-scheduler", services)
        ...
        hive_env_properties = self.getServicesSiteProperties(
            services, "hive-env")
        cap_sched_properties, received_as_key_value_pair = self.getCapacitySchedulerProperties(
            services)
        if hive_env_properties and "hive_user" in hive_env_properties and \
            ...
            if not ("*" in acl_administer_queue_items
                ...
                if not received_as_key_value_pair:
                    ...
                    putCapSchedProperty("capacity-scheduler",
                                        updated_cap_sched_configs_str)
                else:
                    putCapSchedProperty(
                        "yarn.scheduler.capacity.root.acl_administer_queue",
        ...
        spark2_env_properties = self.getServicesSiteProperties(
            services, "spark2-env")
        ...
        if ambari_sso_details and ambari_sso_details.is_managing_services():
            ...
            if ambari_sso_details.should_enable_sso('YARN'):
                if (self.is_kerberos_enabled(configurations, services)):
                    ...
                    putYarnSiteProperty('hadoop.http.authentication.type',
                                        "simple")
                    pass
        ...
        if host_mem < 4096:
            ...
            ats_heapsize = long(
                min(
                    ...
                    long(yarn_timeline_app_cache_size) * 500 + 3072))
        return ats_heapsize
  ...
  """
    ...
    def calculate_yarn_apptimelineserver_cache_size(self, host_mem):
        ...
        self.logger.info(
            "Calculated and returning 'yarn_timeline_app_cache_size' : {0}".
                format(yarn_timeline_app_cache_size))
  ...
  """
    ...
    """
        ...
        yarn_site_in_services = self.getServicesSiteProperties(
            services, "yarn-site")
        ...
        if yarn_site_in_services and yarn_ats_app_cache_size_config in yarn_site_in_services:
            ...
            self.logger.info(
                "'yarn.scheduler.minimum-allocation-mb' read from services as : {0}"
                    .format(yarn_ats_app_cache_size))

        if not yarn_ats_app_cache_size:
            self.logger.error("'{0}' was not found in the services".format(
                yarn_ats_app_cache_size_config))

        return yarn_ats_app_cache_size

    def update_timeline_reader_address(self, configurations, services,
                                       property_name):
        putYarnProperty = self.putProperty(configurations, 'yarn-site',
                                           services)
        yarn_site = self.getServicesSiteProperties(services, 'yarn-site')
        if yarn_site and property_name in yarn_site:
            timeline_hosts = self.getHostsForComponent(services, 'YARN',
                                                       'TIMELINE_READER')
            old_address = yarn_site[property_name]
            if old_address and old_address.count(':') <= 1 and len(
                    timeline_hosts) == 1:
                new_address = re.sub('[^:]+', timeline_hosts[0], old_address,
                                     1)
                if old_address != new_address:
                    putYarnProperty(property_name, new_address)
                    self.logger.info('Updated YARN config {0} to {1}'.format(
    ...
    """
        ...
        self.logger.info("Is cluster create operation ? = {0}".format(
        ...
        if not services["changed-configurations"]:
            read_llap_daemon_yarn_cont_mb = long(
            ...
            putHiveInteractiveSitePropertyAttribute(
                'hive.llap.daemon.yarn.container.mb', "minimum",
                read_llap_daemon_yarn_cont_mb)
            putHiveInteractiveSitePropertyAttribute(
                'hive.llap.daemon.yarn.container.mb', "maximum",
                self.__get_min_hsi_mem(services, hosts) * 0.8)

        if hsi_site and "hive.llap.daemon.queue.name" in hsi_site:
            llap_daemon_selected_queue_name = hsi_site[
        ...
        if capacity_scheduler_properties:
            # Get all leaf queues.
            leafQueueNames = self.getAllYarnLeafQueues(
            ...
            changed_configs_has_enable_hive_int = self.isConfigPropertiesChanged(
                services, "hive-interactive-env", ['enable_hive_interactive'],
                False)
            ...
            if (changed_configs_has_enable_hive_int or 0 == len(services['changed-configurations'])) \
                ...
                if len(leafQueueNames) == 1 or (
                    ...
                    first_leaf_queue = list(
                        leafQueueNames
                    )[0]  # 1st invocation, pick the 1st leaf queue and set it as selected.
                    putHiveInteractiveSiteProperty(
            ...
            self.logger.info(
                "DBG: llap_named_queue_selected_in_curr_invocation = {0}".
                    format(llap_named_queue_selected_in_curr_invocation))

            if (len(leafQueueNames) == 2 and (
                    llap_daemon_selected_queue_name and llap_daemon_selected_queue_name == llap_queue_name) or
                llap_named_queue_selected_in_curr_invocation) or \
                    (len(
                        leafQueueNames) == 1 and llap_daemon_selected_queue_name == 'default' and llap_named_queue_selected_in_curr_invocation):
                self.logger.info(
                ...
                if llap_daemon_selected_queue_name:
                    ...
                    if llap_selected_queue_state is None or llap_selected_queue_state == "STOPPED":
                        self.logger.error(
                            ...
                            "values.".format(llap_daemon_selected_queue_name,
                    ...
                    self.logger.error(
                        "Retrieved LLAP app queue name is : '{0}'. Setting LLAP configs to default values."
        ...
        if 'changed-configurations' in services.keys():
            ...
            changed_configs_in_hive_int_env = self.isConfigPropertiesChanged(
                services, "hive-interactive-env", config_names_to_be_checked,
                False)
            ...
            llap_concurrency_in_changed_configs = self.isConfigPropertiesChanged(
                services, YARNRecommender.HIVE_INTERACTIVE_SITE,
                ['hive.server2.tez.sessions.per.default.queue'], False)
            llap_daemon_queue_in_changed_configs = self.isConfigPropertiesChanged(
                services, YARNRecommender.HIVE_INTERACTIVE_SITE,
                ['hive.llap.daemon.queue.name'], False)
        ...
        if not changed_configs_in_hive_int_env and not llap_concurrency_in_changed_configs and \
            ...
            self.logger.info(
                "DBG: Current 'changed-configuration' received is : {0}".
                    format(services["changed-configurations"]))
            return
        ...
        tez_am_container_size = self.calculate_tez_am_container_size(
            services, long(total_cluster_capacity), is_cluster_create_opr,
        ...
        if yarn_site and "yarn.nodemanager.resource.cpu-vcores" in yarn_site:
            cpu_per_nm_host = float(
                yarn_site["yarn.nodemanager.resource.cpu-vcores"])
        else:
        ...
        self.logger.info(
            ...
            "total_cluster_capacity : {2}".format(
                normalized_tez_am_container_size, tez_am_container_size,
        ...
        mem_per_thread_for_llap = float(
            self.calculate_mem_per_thread_for_llap(
                services, yarn_nm_mem_in_mb_normalized, cpu_per_nm_host,
        ...
        self.logger.info(
            ...
            "{1}".format(yarn_service_am_container_size,
                         yarn_min_container_size))

        min_memory_required = normalized_tez_am_container_size + yarn_service_am_container_size + self._normalizeUp(
        ...
        self.logger.info(
            ...
            "{4}".format(min_memory_required, yarn_service_am_container_size,
        ...
        self.logger.info("DBG: selected_queue_is_ambari_managed_llap = {0}".
                         format(selected_queue_is_ambari_managed_llap))
        if not selected_queue_is_ambari_managed_llap:
            ...
            if llap_daemon_selected_queue_cap <= 0:
                self.logger.warning(
                    "'{0}' queue capacity percentage retrieved = {1}. Expected > 0."
                        .format(llap_daemon_selected_queue_name,
                                llap_daemon_selected_queue_cap))
                self.recommendDefaultLlapConfiguration(configurations,
                                                       services, hosts)
                return
            ...
            self.logger.info(
                ...
                "yarn_min_container_size : {3}".format(
                    llap_daemon_selected_queue_name, total_llap_mem_normalized,
                    llap_daemon_selected_queue_cap, yarn_min_container_size))
            ...
            self.logger.info(
                ...
                "yarn_nm_mem_in_mb_normalized : {2}".format(
                    num_llap_nodes_requested, total_llap_mem_normalized,
                    yarn_nm_mem_in_mb_normalized))
            # Pouplate the 'num_llap_nodes_requested' in config 'num_llap_nodes', a read only config for non-Ambari managed queue case.
            putHiveInteractiveEnvProperty('num_llap_nodes',
                                          num_llap_nodes_requested)
            self.logger.info("Setting config 'num_llap_nodes' as : {0}".format(
                num_llap_nodes_requested))
            ...
            self.logger.info(
                ...
                "yarn_nm_mem_in_mb_normalized : {2}".format(
                    total_llap_mem, num_llap_nodes_requested,
                    yarn_nm_mem_in_mb_normalized))
            ...
            self.logger.info(
                ...
                "yarn_min_container_size : {2}".format(
                    total_llap_mem_normalized, total_llap_mem,
                    yarn_min_container_size))
            ...
            if llap_named_queue_cap_fraction > 100:
                self.logger.warning(
                    "Calculated '{0}' queue size = {1}. Cannot be > 100.".
                        format(llap_queue_name, llap_named_queue_cap_fraction))
                self.recommendDefaultLlapConfiguration(configurations,
                                                       services, hosts)
                return
            ...
            self.logger.info("DBG: hive_tez_am_cap_available : {0}".format(
        ...
        if not llap_concurrency_in_changed_configs:
            if max_executors_per_node <= 0:
                self.logger.warning(
                    "Calculated 'max_executors_per_node' = {0}. Expected value >= 1."
            ...
            self.logger.info(
                ...
                "mem_per_thread_for_llap: {3}".format(
                    max_executors_per_node, yarn_nm_mem_in_mb_normalized,
            ...
            llap_concurreny_limit = min(
                floor(max_executors_per_node * num_llap_nodes_requested /
                      DEFAULT_EXECUTOR_TO_AM_RATIO), MAX_CONCURRENT_QUERIES)
            self.logger.info(
                ...
                ": {3}, MAX_CONCURRENT_QUERIES : {4}".format(
                    llap_concurreny_limit, max_executors_per_node,
            ...
            if llap_concurrency * normalized_tez_am_container_size > hive_tez_am_cap_available:
                llap_concurrency = long(
                    math.floor(hive_tez_am_cap_available /
                               normalized_tez_am_container_size))
                self.logger.info(
                    "DBG: Readjusted 'llap_concurrency' to : {0}, as llap_concurrency({1}) * normalized_tez_am_container_size({2}) > hive_tez_am_cap_available({3}))"
                        .format(llap_concurrency, llap_concurrency,
                                normalized_tez_am_container_size,
                                hive_tez_am_cap_available))

                if llap_concurrency <= 0:
                    self.logger.warning(
                        "DBG: Calculated 'LLAP Concurrent Queries' = {0}. Expected value >= 1."
                ...
                self.logger.info(
                    ...
                    "{2}".format(llap_concurrency, hive_tez_am_cap_available,
                                 normalized_tez_am_container_size))
        else:
            # Read current value
            if 'hive.server2.tez.sessions.per.default.queue' in hsi_site:
                ...
                if llap_concurrency <= 0:
                    self.logger.warning(
                        "'hive.server2.tez.sessions.per.default.queue' current value : {0}. Expected value : >= 1"
                            .format(llap_concurrency))
                    self.recommendDefaultLlapConfiguration(
                        configurations, services, hosts)
                    return
                self.logger.info("DBG: Read 'llap_concurrency' : {0}".format(
                    llap_concurrency))
            else:
                llap_concurrency = 1
                self.logger.warning(
        ...
        max_llap_concurreny_limit = min(
            floor(max_executors_per_node * num_llap_nodes_requested /
                  MIN_EXECUTOR_TO_AM_RATIO), MAX_CONCURRENT_QUERIES)
        self.logger.info(
            "DBG: Calculated 'max_llap_concurreny_limit' : {0}, using following : max_executors_per_node : {1}, num_llap_nodes_requested "
            ": {2}, MIN_EXECUTOR_TO_AM_RATIO : {3}, MAX_CONCURRENT_QUERIES : {4}"
                .format(max_llap_concurreny_limit, max_executors_per_node,
        ...
        if llap_mem_daemon_size < yarn_min_container_size:
            self.logger.warning(
                "Calculated 'LLAP Daemon Size = {0}'. Expected >= 'YARN Minimum Container Size' ({1})'"
                    .format(llap_mem_daemon_size, yarn_min_container_size))
            self.recommendDefaultLlapConfiguration(configurations, services,
                                                   hosts)
            return
        ...
        self.logger.info(
            ...
            "{2}".format(llap_mem_daemon_size, llap_mem_for_tezAm_and_daemons,
                         tez_am_memory_required))

        llap_daemon_mem_per_node = self._normalizeDown(
            llap_mem_daemon_size / num_llap_nodes_requested,
            yarn_min_container_size)
        ...
        self.logger.info(
            ...
            "yarn_min_container_size: {3}".format(
                llap_daemon_mem_per_node, llap_mem_daemon_size,
        ...
        if llap_daemon_mem_per_node == 0:
            ...
            llap_daemon_mem_per_node = self._normalizeUp(
                mem_per_thread_for_llap, yarn_min_container_size)
            num_llap_nodes = floor(
                llap_mem_daemon_size / llap_daemon_mem_per_node)
            self.logger.info(
                ...
                "mem_per_thread_for_llap : {3}".format(
                    llap_daemon_mem_per_node, num_llap_nodes,
            ...
            self.logger.info(
                "DBG: num_llap_nodes : {0}".format(num_llap_nodes))
        ...
        if num_llap_nodes == num_llap_nodes_requested and num_llap_nodes == node_manager_cnt:
            min_mem_reserved_per_node = max(normalized_tez_am_container_size,
                                            yarn_service_am_container_size)
            ...
            min_mem_reserved_per_node = int(
                max(
                    ...
                    yarn_service_am_container_size))
            self.logger.info(
                "DBG: Determined 'AM reservation per node': {0}, using following : concurrency: {1}, num_llap_nodes: {2}, AMsPerNode: {3}"
                    .format(min_mem_reserved_per_node, llap_concurrency,
                            num_llap_nodes, tez_AMs_per_node))
        ...
        self.logger.info(
            "DBG: Determined final memPerDaemon: {0}, using following: concurrency: {1}, numNMNodes: {2}, numLlapNodes: {3} "
                .format(llap_daemon_mem_per_node, llap_concurrency,
                        node_manager_cnt, num_llap_nodes))
        ...
        if num_executors_per_node_max < 1:
            self.logger.warning(
                "Calculated 'Max. Executors per Node' = {0}. Expected values >= 1."
                    .format(num_executors_per_node_max))
            self.recommendDefaultLlapConfiguration(configurations, services,
                                                   hosts)
            return
        self.logger.info(
            ...
            "mem_per_thread_for_llap: {3}".format(
                num_executors_per_node_max, yarn_nm_mem_in_mb_normalized,
                cpu_per_nm_host, mem_per_thread_for_llap))
        ...
        if num_executors_per_node <= 0:
            self.logger.warning(
                "Calculated 'Number of Executors Per Node' = {0}. Expected value >= 1"
                    .format(num_executors_per_node))
            self.recommendDefaultLlapConfiguration(configurations, services,
                                                   hosts)
            return
        self.logger.info(
            ...
            "mem_per_thread_for_llap: {3}".format(
                num_executors_per_node, llap_daemon_mem_per_node,
        ...
        self.logger.info(
            "DBG: Calculated 'Cache per node' : {0}, using following : llap_daemon_mem_per_node : {1}, total_mem_for_executors_per_node : {2}"
                .format(cache_mem_per_node, llap_daemon_mem_per_node,
                        total_mem_for_executors_per_node))

        tez_runtime_io_sort_mb = (long((0.8 * mem_per_thread_for_llap) / 3))
        tez_runtime_unordered_output_buffer_size = long(
        ...
        hive_auto_convert_join_noconditionaltask_size = (long(
            (0.8 * mem_per_thread_for_llap) / 3)) * MB_TO_BYTES

        # Calculate value for prop 'llap_heap_size'
        llap_xmx = max(
            total_mem_for_executors_per_node * 0.8,
            total_mem_for_executors_per_node - self.get_llap_headroom_space(
                services, configurations))
        self.logger.info(
            "DBG: Calculated llap_app_heap_size : {0}, using following : total_mem_for_executors : {1}"
                .format(llap_xmx, total_mem_for_executors_per_node))
        ...
        if hive_server_interactive_hosts is not None and len(
                hive_server_interactive_hosts) > 0:
            host_mem = long(
                hive_server_interactive_hosts[0]["Hosts"]["total_mem"])
        ...
        if is_cluster_create_opr or changed_configs_has_enable_hive_int:
            normalized_tez_am_container_size = long(
                normalized_tez_am_container_size)
            putTezInteractiveSiteProperty('tez.am.resource.memory.mb',
                                          min(30720,normalized_tez_am_container_size))
            self.logger.info(
                "DBG: Setting 'tez.am.resource.memory.mb' config value as : {0}"
                    .format(normalized_tez_am_container_size))

        if not llap_concurrency_in_changed_configs:
            putHiveInteractiveSiteProperty(
                'hive.server2.tez.sessions.per.default.queue',
                max(long(num_executors_per_node / 16), 1))
        putHiveInteractiveSitePropertyAttribute(
            'hive.server2.tez.sessions.per.default.queue', "maximum",
            max(long(num_executors_per_node / 4), 1))
        ...
        if (num_llap_nodes != num_llap_nodes_requested):
            self.logger.info(
                "DBG: User requested num_llap_nodes : {0}, but used/adjusted value for calculations is : {1}"
                    .format(num_llap_nodes_requested, num_llap_nodes))
        else:
            self.logger.info("DBG: Used num_llap_nodes for calculations : {0}".
                             format(num_llap_nodes_requested))
        ...
        if "hive-interactive-env" in services["configurations"] and \
            ...
            putHiveInteractiveEnvProperty('num_llap_nodes_for_llap_daemons',
                                          num_llap_nodes)
            self.logger.info(
                "DBG: Setting config 'num_llap_nodes_for_llap_daemons' as : {0}"
                    .format(num_llap_nodes))
        ...
        if is_cluster_create_opr or changed_configs_has_enable_hive_int:
            ...
            putHiveInteractiveSiteProperty('hive.tez.container.size',
                                           mem_per_thread_for_llap)
            self.logger.info(
                "DBG: Setting 'hive.tez.container.size' config value as : {0}".
                    format(mem_per_thread_for_llap))

        putTezInteractiveSiteProperty('tez.runtime.io.sort.mb',
                                      tez_runtime_io_sort_mb)
        if "tez-site" in services[
            "configurations"] and "tez.runtime.sorter.class" in services[
            "configurations"]["tez-site"]["properties"]:
            if services["configurations"]["tez-site"]["properties"][
        ...
        self.logger.info("DBG: Putting num_executors_per_node as {0}".format(
        ...
        putHiveInteractiveSitePropertyAttribute(
            'hive.llap.daemon.num.executors', "maximum",
            long(num_executors_per_node_max))
        ...
        putHiveInteractiveSiteProperty('hive.llap.io.threadpool.size',
                                       num_executors_per_node)
        putHiveInteractiveSiteProperty('hive.llap.io.memory.size',
                                       cache_mem_per_node)
        putHiveInteractiveSitePropertyAttribute('hive.llap.io.memory.size',
                                                'minimum', 0)
        putHiveInteractiveSitePropertyAttribute(
            'hive.llap.io.memory.size', 'maximum',
            self.__get_min_hsi_mem(services, hosts) * 0.8)
        ...
        ssd_cache_on = services["configurations"]["hive-interactive-site"][
                           "properties"]["hive.llap.io.allocator.mmap"] == "true"
        llap_io_enabled = 'true' if long(
            cache_mem_per_node) >= 1024 or ssd_cache_on else 'false'
        services["forced-configurations"].append({
            "type":
    ...
    def recommendDefaultLlapConfiguration(self, configurations, services,
                                          hosts):
        self.logger.info(
    ...
    :rtype int
    """
        hsi_env = self.getServicesSiteProperties(services,
                                                 "hive-interactive-env")
        hsi_env_properties = self.getSiteProperties(configurations,
                                                    "hive-interactive-env")
        num_llap_nodes = 0
        ...
        if hsi_env_properties and 'num_llap_nodes' in hsi_env_properties:
            ...
            self.logger.error(
                "Couldn't retrieve Hive Server 'num_llap_nodes' config. Setting value to {0}"
                    .format(num_llap_nodes))

        return float(num_llap_nodes)

    def get_max_executors_per_node(self, nm_mem_per_node_normalized,
                                   nm_cpus_per_node, mem_per_thread):
        # TODO: This potentially takes up the entire node leaving no space for AMs.
        return min(
            floor(nm_mem_per_node_normalized / mem_per_thread),
            nm_cpus_per_node)
    ...
    """
        ...
        if is_cluster_create_opr or enable_hive_interactive_1st_invocation:
            ...
            self.logger.info(
                "DBG: Calculated and returning 'hive_tez_container_size' : {0}"
                    .format(calculated_hive_tez_container_size))
            return calculated_hive_tez_container_size
        else:
            self.logger.info("DBG: Returning 'hive_tez_container_size' : {0}".
                             format(hive_tez_container_size))
    ...
    """
        ...
        if 'hive-interactive-env' in configurations and 'llap_headroom_space' in configurations[
            'hive-interactive-env']['properties']:
            hive_container_size = float(configurations['hive-interactive-env']
                                        ['properties']['llap_headroom_space'])
            self.logger.info(
                "'llap_headroom_space' read from configurations as : {0}".
                    format(llap_headroom_space))

        if llap_headroom_space is None:
            # Check if 'llap_headroom_space' is input in services array.
            if 'llap_headroom_space' in services['configurations'][
                'hive-interactive-env']['properties']:
                llap_headroom_space = float(
                    services['configurations']['hive-interactive-env']
                    ['properties']['llap_headroom_space'])
                self.logger.info(
    ...
    def checkAndManageLlapQueue(self, services, configurations, hosts,
        ...
        if capacity_scheduler_properties:
            ...
            if 'yarn.scheduler.capacity.root.' + llap_queue_name + '.state' in cap_sched_config_keys:
                currLlapQueueState = capacity_scheduler_properties.get(
                    'yarn.scheduler.capacity.root.' + llap_queue_name +
                    '.state')
            ...
            if 'yarn.scheduler.capacity.root.' + llap_queue_name + '.capacity' in cap_sched_config_keys:
                currLlapQueueCap = int(
                    float(
                        capacity_scheduler_properties.
                            get('yarn.scheduler.capacity.root.' + llap_queue_name +
                                '.capacity')))
                    ...
                    ((len(leafQueueNames) == 1 and int(yarn_default_queue_capacity) == 100) or
                     ((len(leafQueueNames) == 2 and llap_queue_name in leafQueueNames) and
                      ((currLlapQueueState == 'STOPPED' and enabled_hive_int_in_changed_configs) or (
                              currLlapQueueState == 'RUNNING' and currLlapQueueCap != llap_queue_cap_perc)))):
                adjusted_default_queue_cap = str(100 - llap_queue_cap_perc)

                hive_user = '*'  # Open to all
                if 'hive_user' in services['configurations']['hive-env'][
                    'properties']:
...
yarn.scheduler.capacity.root.{0}.maximum-am-resource-percent=1""".format(
                    ...
                    putCapSchedProperty(
                        "yarn.scheduler.capacity.root." + llap_queue_name +
                        ".maximum-capacity", llap_queue_cap_perc)
                    putCapSchedProperty(
                        "yarn.scheduler.capacity.root." + llap_queue_name +
                        ".capacity", llap_queue_cap_perc)
                    putCapSchedProperty(
                        "yarn.scheduler.capacity.root." + llap_queue_name +
                        ".acl_submit_applications", hive_user)
                    putCapSchedProperty(
                        "yarn.scheduler.capacity.root." + llap_queue_name +
                        ".acl_administer_queue", hive_user)
                    putCapSchedProperty(
                        "yarn.scheduler.capacity.root." + llap_queue_name +
                        ".maximum-am-resource-percent", "1")
                ...
                if updated_cap_sched_configs_str or updated_cap_sched_configs_as_dict:
                    if len(leafQueueNames
                           ) == 1:  # 'llap' queue didn't exist before
                        self.logger.info(
                        ...
                        self.logger.info(
                            "Adjusted YARN Queue : '{0}'. Current capacity : {1}%. State: RUNNING."
                                .format(llap_queue_name, llap_queue_cap_perc))
                        self.logger.info(
                            "Adjusted 'default' queue capacity to : {0}%".
                                format(adjusted_default_queue_cap))
                    ...
                    self.setLlapDaemonQueuePropAttributes(
                        services, configurations)
            else:
                self.logger.debug(
                    "Not creating/adjusting {0} queue. Current YARN queues : {1}"
                        .format(llap_queue_name, list(leafQueueNames)))
        else:
            self.logger.error(
                "Couldn't retrieve 'capacity-scheduler' properties while doing YARN queue adjustment for Hive Server Interactive."
            )
    ...
    """
        ...
        if capacity_scheduler_properties:
            ...
            if len(
                    leafQueueNames
            ) == 2 and llap_queue_name in leafQueueNames and 'default' in leafQueueNames:
                # Get 'llap' queue state
                ...
                if 'yarn.scheduler.capacity.root.' + llap_queue_name + '.state' in capacity_scheduler_properties.keys(
                    ...
                    self.logger.error(
                        "{0} queue 'state' property not present in capacity scheduler. Skipping adjusting queues."
                            .format(llap_queue_name))
                    return
                if currLlapQueueState == 'RUNNING':
                    ...
                    self.logger.debug(
                        "{0} queue state is : {1}. Skipping adjusting queues.".
                            format(llap_queue_name, currLlapQueueState))
                    return

                if updated_default_queue_configs and updated_llap_queue_configs:
                    putCapSchedProperty(
                        "capacity-scheduler", updated_default_queue_configs +
                                              updated_llap_queue_configs)
                    self.logger.info(
                ...
                self.logger.debug(
                    "Not removing '{0}' queue as number of Queues not equal to 2. Current YARN queues : {1}"
                        .format(llap_queue_name, list(leafQueueNames)))
        else:
            self.logger.error(
                "Couldn't retrieve 'capacity-scheduler' properties while doing YARN queue adjustment for Hive Server Interactive."
    ...
    """
        ...
        if "capacity-scheduler" in configurations:
            cap_sched_props_as_dict = configurations["capacity-scheduler"][
                "properties"]
            if 'capacity-scheduler' in cap_sched_props_as_dict:
                ...
                if cap_sched_props_as_str:
                    cap_sched_props_as_str = str(cap_sched_props_as_str).split(
                        '\n')
                    if len(cap_sched_props_as_str
                           ) > 0 and cap_sched_props_as_str[0] != 'null':
                        ...
                        self.logger.info(
                            "Read configurations['capacity-scheduler']['properties']['capacity-scheduler'] is : {0}"
                                .format(cap_sched_props_as_str))
                else:
                    self.logger.info(
                        "configurations['capacity-scheduler']['properties']['capacity-scheduler'] : {0}."
                            .format(cap_sched_props_as_str))
            ...
            if not capacity_scheduler_properties:
                if isinstance(cap_sched_props_as_dict,
                              dict) and len(cap_sched_props_as_dict) > 1:
                    ...
                    self.logger.info(
                        "Read configurations['capacity-scheduler']['properties'] is : {0}"
                            .format(cap_sched_props_as_dict))
        else:
            self.logger.info(
        ...
        if leafQueueNames:
            ...
            self.logger.info(
                "'hive.llap.daemon.queue.name' config Property Attributes set to : {0}"
                    .format(leafQueues))
        else:
            self.logger.error(
    ...
    """
        ...
        yarn_site_properties = self.getServicesSiteProperties(
            services, "yarn-site")
        ...
        if not services[
            "changed-configurations"] and yarn_site and yarn_min_allocation_property in yarn_site:
            yarn_min_container_size = yarn_site[yarn_min_allocation_property]
            self.logger.info(
                "DBG: 'yarn.scheduler.minimum-allocation-mb' read from output as : {0}"
                    .format(yarn_min_container_size))
        ...
        # Check if 'yarn.scheduler.minimum-allocation-mb' is input in services array.
            ...
            yarn_min_container_size = yarn_site_properties[
                yarn_min_allocation_property]
            self.logger.info(
                "DBG: 'yarn.scheduler.minimum-allocation-mb' read from services as : {0}"
                    .format(yarn_min_container_size))

        if not yarn_min_container_size:
            self.logger.error("{0} was not found in the configuration".format(
                yarn_min_allocation_property))
    ...
    """
        ...
        yarn_site = self.getServicesSiteProperties(services, "yarn-site")
        yarn_site_properties = self.getSiteProperties(configurations,
                                                      "yarn-site")
        ...
        if not services[
            "changed-configurations"] and yarn_site_properties and 'yarn.nodemanager.resource.memory-mb' in yarn_site_properties:
            ...
            yarn_nm_mem_in_mb = float(
                yarn_site['yarn.nodemanager.resource.memory-mb'])

        if yarn_nm_mem_in_mb <= 0.0:
            self.logger.warning(
                "'yarn.nodemanager.resource.memory-mb' current value : {0}. Expected value : > 0"
                    .format(yarn_nm_mem_in_mb))
    ...
    """
        ...
        if is_cluster_create_opr or enable_hive_interactive_1st_invocation:
            ...
            self.logger.info(
                "DBG: Calculated and returning 'tez_am_resource_memory_mb' as : {0}"
                    .format(calculated_tez_am_resource_memory_mb))
    ...
    """
        ...
        if 'tez.am.resource.memory.mb' in services['configurations'][
            'tez-interactive-site']['properties']:
    ...
    def min_queue_perc_reqd_for_llap_and_hive_app(self, services, hosts,
                                                  configurations):
        """
    ...
    """
        ...
        node_manager_hosts = self.getHostsForComponent(services, "YARN",
                                                       "NODEMANAGER")
        ...
        hive_tez_container_size = long(
            self.get_hive_tez_container_size(services))
        tez_am_container_size = self.calculate_tez_am_container_size(
            services, long(total_cluster_cap))
    ...
    def __getQueueStateFromCapacityScheduler(self,
                                             capacity_scheduler_properties,
                                             llap_daemon_selected_queue_name):
        """
    ...
    """
        ...
        for key in cap_sched_keys:
            if key.endswith("." + llap_daemon_selected_queue_name +
        ...
        if llap_selected_queue_am_percent_key is None:
            self.logger.info(
                "Returning default AM percent value : '0.1' for queue : {0}".
                    format(llap_daemon_selected_queue_name))
            ...
            llap_selected_queue_am_percent = capacity_scheduler_properties.get(
                llap_selected_queue_am_percent_key)
            self.logger.info(
                "Returning read value for key '{0}' as : '{1}' for queue : '{2}'"
                    .format(llap_selected_queue_am_percent_key,
    ...
    """
        self.logger.info(
            "Entered __getSelectedQueueTotalCap fn() with llap_daemon_selected_queue_name= '{0}'."
                .format(llap_daemon_selected_queue_name))
            ...
            if len(
                ...
                if queues_list:
                    for queue in queues_list:
                        ...
                        self.logger.info(
                            "Total capacity available for queue {0} is : {1}".
                                format(queue, available_capacity))
  ...
  """
    ...
    def recommendMapReduce2ConfigurationsFromHDP206(
        ...
        putMapredProperty = self.putProperty(configurations, "mapred-site",
                                             services)
        putMapredProperty('yarn.app.mapreduce.am.resource.mb', min(30720, int(clusterData['amMemory'])))
        putMapredProperty(
            'yarn.app.mapreduce.am.command-opts',
            "-Xmx" + str(min(30720, int(round(0.8 * clusterData['amMemory'])))) + "m")
        putMapredProperty('mapreduce.map.memory.mb', min(15360, int(clusterData['mapMemory'])))
        putMapredProperty('mapreduce.reduce.memory.mb', min(15360, int(clusterData['reduceMemory'])))
        putMapredProperty(
            'mapreduce.map.java.opts',
            "-Xmx" + str(min(15360, int(round(0.8 * clusterData['mapMemory'])))) + "m")
        putMapredProperty(
            'mapreduce.reduce.java.opts',
            "-Xmx" + str(min(15360, int(round(0.8 * clusterData['reduceMemory'])))) + "m")
        putMapredProperty(
            'mapreduce.task.io.sort.mb',
            min(int(round(0.4 * clusterData['mapMemory'])), 1024))

        mapred_mounts = [("mapred.local.dir", ["TASKTRACKER", "NODEMANAGER"],
                          "/data1/mapred", "multi")]

        self.updateMountProperties("mapred-site", mapred_mounts,
                                   configurations, services, hosts)
    ...
    def recommendMapReduce2ConfigurationsFromHDP22(
        ...
        self.recommendYARNConfigurationsFromHDP206(configurations, clusterData,
                                                   services, hosts)
        self.recommendYARNConfigurationsFromHDP22(configurations, clusterData,
                                                  services, hosts)
            ...
            min(
                max(
                    ...
                    int(configurations["yarn-site"]["properties"]
                        ["yarn.scheduler.minimum-allocation-mb"])),30720))
        putMapredProperty(
            'yarn.app.mapreduce.am.command-opts', "-Xmx" + str(
        ...
        mapredMapXmx = int(
            0.8 * int(configurations["mapred-site"]["properties"]
                      ["mapreduce.map.memory.mb"]))
        putMapredProperty(
            'mapreduce.map.java.opts',
            "-Xmx" + str(max(min_mapreduce_map_java_opts, mapredMapXmx)) + "m")
        putMapredProperty(
            'mapreduce.reduce.java.opts', "-Xmx" + str(
                int(0.8 * int(configurations["mapred-site"]["properties"]
        ...
        yarnMinAllocationSize = int(configurations["yarn-site"]["properties"]
                                    ["yarn.scheduler.minimum-allocation-mb"])
        yarnMaxAllocationSize = min(
            30 * int(configurations["yarn-site"]["properties"]
                     ["yarn.scheduler.minimum-allocation-mb"]),
            int(configurations["yarn-site"]["properties"]
                ["yarn.scheduler.maximum-allocation-mb"]))
        putMapredPropertyAttribute("mapreduce.map.memory.mb", "maximum",
                                   yarnMaxAllocationSize)
        putMapredPropertyAttribute("mapreduce.map.memory.mb", "minimum",
                                   yarnMinAllocationSize)
        putMapredPropertyAttribute("mapreduce.reduce.memory.mb", "maximum",
                                   yarnMaxAllocationSize)
        putMapredPropertyAttribute("mapreduce.reduce.memory.mb", "minimum",
                                   yarnMinAllocationSize)
        putMapredPropertyAttribute("yarn.app.mapreduce.am.resource.mb",
                                   "maximum", yarnMaxAllocationSize)
        putMapredPropertyAttribute("yarn.app.mapreduce.am.resource.mb",
                                   "minimum", yarnMinAllocationSize)
        # Hadoop MR limitation
        putMapredPropertyAttribute("mapreduce.task.io.sort.mb", "maximum",
                                   "2047")
    ...
    def recommendConfigurationsForSSO(self, configurations, clusterData,
        ...
        if ambari_sso_details and ambari_sso_details.is_managing_services():
            putMapRedSiteProperty = self.putProperty(configurations,
                                                     "mapred-site", services)
            ...
            if ambari_sso_details.should_enable_sso('MAPREDUCE2'):
                if (self.is_kerberos_enabled(configurations, services)):
                    ...
                    putMapRedSiteProperty('hadoop.http.authentication.type',
                                          "simple")
                    pass
...
class YARNValidator(service_advisor.ServiceAdvisor):
  ...
  """
        ...
        validationItems = [
            ...
            },
            {
                "config-name":
                    'yarn.nodemanager.linux-container-executor.group',
                "item":
                    self.validatorEqualsPropertyItem(
                        properties,
                        "yarn.nodemanager.linux-container-executor.group",
    ...
    def validateYARNSiteConfigurationsFromHDP26(
        ...
        if services["configurations"]["yarn-site"]["properties"][
            "yarn.log.server.web-service.url"] != propertyValue:
            validationItems = [{
                "config-name":
                    "yarn.log.server.web-service.url",
                "item":
                    self.getWarnItem("Value should be %s" % propertyValue)
            }]

        if "yarn_hierarchy" in services["configurations"]["container-executor"]["properties"] \
                and "yarn.nodemanager.linux-container-executor.cgroups.hierarchy" in \
                services["configurations"]["yarn-site"]["properties"]:
            yn_hirch = services["configurations"]["container-executor"][
                "properties"]["yarn_hierarchy"]
    ...
    """
        ...
        if "yarn_cgroups_enabled" in properties:
            ...
            core_site_properties = self.getSiteProperties(
                configurations, "core-site")
            security_enabled = False
            # if core_site_properties:
            #     security_enabled = core_site_properties[
            #                            'hadoop.security.authentication'] == 'kerberos' and core_site_properties[
    ...
    """
        ...
        ranger_plugin_enabled = ranger_plugin_properties[
            'ranger-yarn-plugin-enabled'] if ranger_plugin_properties else 'No'
...
class MAPREDUCE2Validator(service_advisor.ServiceAdvisor):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.validators = [
            ("mapred-site",
             self.validateMapReduce2SiteConfigurationsFromHDP206),
    ...
    """
        ...
        if 'mapreduce.map.java.opts' in properties and \
            ...
            mapreduceMapJavaOpts = self.formatXmxSizeToBytes(
                self.getXmxSize(
                    properties['mapreduce.map.java.opts'])) / (1024.0 * 1024)
            mapreduceMapMemoryMb = self.to_number(
            ...
            if mapreduceMapJavaOpts > mapreduceMapMemoryMb:
                validationItems.append({
                    ...
                    "item":
                        self.getWarnItem(
                            "mapreduce.map.java.opts Xmx should be less than mapreduce.map.memory.mb ({0})"
                                .format(mapreduceMapMemoryMb))
                })
        ...
        if 'mapreduce.reduce.java.opts' in properties and \
            ...
            if mapreduceReduceJavaOpts > mapreduceReduceMemoryMb:
                validationItems.append({
                    ...
                    "item":
                        self.getWarnItem(
                            "mapreduce.reduce.java.opts Xmx should be less than mapreduce.reduce.memory.mb ({0})"
                                .format(mapreduceReduceMemoryMb))
                })
        ...
        if 'yarn.app.mapreduce.am.command-opts' in properties and \
            ...
            if yarnAppMapreduceAmCommandOpts > yarnAppMapreduceAmResourceMb:
                validationItems.append({
                    ...
                    "item":
                        self.getWarnItem(
                            "yarn.app.mapreduce.am.command-opts Xmx should be less than yarn.app.mapreduce.am.resource.mb ({0})"
                                .format(yarnAppMapreduceAmResourceMb))
                })
