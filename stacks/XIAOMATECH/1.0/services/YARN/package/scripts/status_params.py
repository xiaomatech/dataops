...
nodemanager_pid_file = format(
    "{yarn_pid_dir}/hadoop-{yarn_user}-nodemanager.pid")
...
yarn_registry_dns_pid_file = format(
    "{yarn_pid_dir}/hadoop-{yarn_user}-registrydns.pid")
yarn_registry_dns_priv_pid_file = format(
    "{yarn_pid_dir}/hadoop-{yarn_user}-{root_user}-registrydns.pid")
