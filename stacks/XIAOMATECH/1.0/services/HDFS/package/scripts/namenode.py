...
class NameNode(Script):
    ...
    def stop(self, env):
        ...
        namenode(action="stop", hdfs_binary=hdfs_binary, env=env)
    ...
    """
        ...
        if summary is not None and summary.is_downgrade_allowed:
            ...
            Logger.info(
                "Downgrade will not be possible. Skipping '-rollingUpgrade prepare'"
            )
    ...
    def rebalancehdfs(self, env):
        ...
        if params.security_enabled:
            ...
            ccache_file_name = "hdfs_rebalance_cc_" + HASH_ALGORITHM(
                format(
