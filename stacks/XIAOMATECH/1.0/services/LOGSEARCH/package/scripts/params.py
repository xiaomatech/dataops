...
configurations = config[
    'configurations']  # need reference inside logfeeder jinja templates
...
if 'metrics_collector_hosts' in config['clusterHostInfo']:
    ...
    metrics_collector_hosts = ",".join(
        config['clusterHostInfo']['metrics_collector_hosts'])
...
if 'infra-solr-env' in config['configurations']:
    infra_solr_znode = default(
        '/configurations/infra-solr-env/infra_solr_znode', '/infra-solr')
...
if security_enabled:
    ...
    use_external_solr_with_kerberos = default(
        'configurations/logsearch-common-env/logsearch_external_solr_kerberos_enabled',
        False)
    if use_external_solr_with_kerberos:
        logsearch_kerberos_keytab = config['configurations']['logsearch-env'][
            'logsearch_external_solr_kerberos_keytab']
        logsearch_kerberos_principal = config['configurations'][
            'logsearch-env'][
                'logsearch_external_solr_kerberos_principal'].replace(
                    '_HOST', _hostname_lowercase)
        logfeeder_kerberos_keytab = config['configurations']['logfeeder-env'][
            'logfeeder_external_solr_kerberos_keytab']
        logfeeder_kerberos_principal = config['configurations'][
            'logfeeder-env'][
                'logfeeder_external_solr_kerberos_principal'].replace(
                    '_HOST', _hostname_lowercase)
    else:
        logsearch_kerberos_keytab = config['configurations']['logsearch-env'][
            'logsearch_kerberos_keytab']
        logsearch_kerberos_principal = config['configurations'][
            'logsearch-env']['logsearch_kerberos_principal'].replace(
                '_HOST', _hostname_lowercase)
        logfeeder_kerberos_keytab = config['configurations']['logfeeder-env'][
            'logfeeder_kerberos_keytab']
        logfeeder_kerberos_principal = config['configurations'][
            'logfeeder-env']['logfeeder_kerberos_principal'].replace(
                '_HOST', _hostname_lowercase)
    ...
    external_zk_principal_enabled = default(
        "/configurations/logsearch-common-env/logsearch_zookeeper_external_principal",
        False)
    ...
    logsearch_kerberos_service_users_str = str(
        default(
            '/configurations/logsearch-env/logsearch_kerberos_service_users',
            ''))
...
logsearch_spnego_host = config['configurations']['logsearch-properties'][
    'logsearch.spnego.kerberos.host'].replace('_HOST', _hostname_lowercase)
...
logsearch_service_logs_max_retention = config['configurations'][
    'logsearch-service_logs-solrconfig'][
        'logsearch_service_logs_max_retention']
logsearch_service_logs_merge_factor = config['configurations'][
    'logsearch-service_logs-solrconfig']['logsearch_service_logs_merge_factor']

logsearch_audit_logs_max_retention = config['configurations'][
    'logsearch-audit_logs-solrconfig']['logsearch_audit_logs_max_retention']
logsearch_audit_logs_merge_factor = config['configurations'][
    'logsearch-audit_logs-solrconfig']['logsearch_audit_logs_merge_factor']

logsearch_use_external_solr = default(
    '/configurations/logsearch-common-env/logsearch_use_external_solr', False)

if logsearch_use_external_solr:
    logsearch_solr_zk_znode = config['configurations']['logsearch-common-env'][
        'logsearch_external_solr_zk_znode']
    logsearch_solr_zk_quorum = config['configurations'][
        'logsearch-common-env']['logsearch_external_solr_zk_quorum']
    logsearch_solr_ssl_enabled = default(
        'configurations/logsearch-common-env/logsearch_external_solr_ssl_enabled',
        False)
...
logsearch_log_dir = config['configurations']['logsearch-env'][
    'logsearch_log_dir']
logsearch_log = 'logsearch.out'
logsearch_debug_enabled = str(config['configurations']['logsearch-env']
                              ["logsearch_debug_enabled"]).lower()
logsearch_debug_port = config['configurations']['logsearch-env'][
    "logsearch_debug_port"]
logsearch_app_max_memory = config['configurations']['logsearch-env'][
    'logsearch_app_max_memory']

logsearch_keystore_location = config['configurations']['logsearch-env'][
    'logsearch_keystore_location']
logsearch_keystore_type = config['configurations']['logsearch-env'][
    'logsearch_keystore_type']
logsearch_keystore_password = config['configurations']['logsearch-env'][
    'logsearch_keystore_password']
logsearch_truststore_location = config['configurations']['logsearch-env'][
    'logsearch_truststore_location']
logsearch_truststore_type = config['configurations']['logsearch-env'][
    'logsearch_truststore_type']
logsearch_truststore_password = config['configurations']['logsearch-env'][
    'logsearch_truststore_password']

logsearch_env_config = dict(config['configurations']['logsearch-env'])
logsearch_env_jceks_file = os.path.join(logsearch_server_conf,
                                        'logsearch.jceks')

#Logsearch log4j properties
logsearch_log_maxfilesize = default(
    '/configurations/logsearch-log4j/logsearch_log_maxfilesize', 10)
logsearch_log_maxbackupindex = default(
    '/configurations/logsearch-log4j/logsearch_log_maxbackupindex', 10)
logsearch_json_log_maxfilesize = default(
    '/configurations/logsearch-log4j/logsearch_json_log_maxfilesize', 10)
logsearch_json_log_maxbackupindex = default(
    '/configurations/logsearch-log4j/logsearch_json_log_maxbackupindex', 10)
logsearch_audit_log_maxfilesize = default(
    '/configurations/logsearch-log4j/logsearch_audit_log_maxfilesize', 10)
logsearch_audit_log_maxbackupindex = default(
    '/configurations/logsearch-log4j/logsearch_audit_log_maxbackupindex', 10)
logsearch_perf_log_maxfilesize = default(
    '/configurations/logsearch-log4j/logsearch_perf_log_maxfilesize', 10)
logsearch_perf_log_maxbackupindex = default(
    '/configurations/logsearch-log4j/logsearch_perf_log_maxbackupindex', 10)
...
logsearch_service_logs_solrconfig_content = config['configurations'][
    'logsearch-service_logs-solrconfig']['content']
logsearch_audit_logs_solrconfig_content = config['configurations'][
    'logsearch-audit_logs-solrconfig']['content']
logsearch_app_log4j_content = config['configurations']['logsearch-log4j'][
    'content']

# Log dirs
ambari_server_log_dir = default(
    '/configurations/logfeeder-env/ambari_server_log_dir',
    "/var/log/ambari-server")
ambari_agent_log_dir = default(
    '/configurations/logfeeder-env/ambari_agent_log_dir',
    "/var/log/ambari-agent")

# System logs
logfeeder_system_messages_content = config['configurations'][
    'logfeeder-system_log-env']['logfeeder_system_messages_content']
logfeeder_secure_log_content = config['configurations'][
    'logfeeder-system_log-env']['logfeeder_secure_log_content']
logfeeder_system_log_enabled = default(
    '/configurations/logfeeder-system_log-env/logfeeder_system_log_enabled',
    False)

# Logsearch auth configs

logsearch_admin_credential_file = 'logsearch-admin.json'
logsearch_admin_username = default(
    '/configurations/logsearch-admin-json/logsearch_admin_username', "admin")
logsearch_admin_password = default(
    '/configurations/logsearch-admin-json/logsearch_admin_password', "")
logsearch_admin_content = config['configurations']['logsearch-admin-json'][
    'content']
...
if 'ambari_server_host' in config['ambariLevelParams']:
    ...
    ambari_server_use_ssl = config['ambariLevelParams'][
...
logsearch_protocol = config['configurations']['logsearch-properties'][
    "logsearch.protocol"]
logsearch_http_port = config['configurations']['logsearch-properties'][
    "logsearch.http.port"]
logsearch_https_port = config['configurations']['logsearch-properties'][
    "logsearch.https.port"]
...
logsearch_properties[
    'logsearch.solr.zk_connect_string'] = logsearch_solr_zk_quorum + logsearch_solr_zk_znode
logsearch_properties[
    'logsearch.solr.audit.logs.zk_connect_string'] = logsearch_solr_zk_quorum + logsearch_solr_zk_znode
...
if not ('logsearch.config.zk_connect_string' in logsearch_properties):
    logsearch_properties[
        'logsearch.config.zk_connect_string'] = logsearch_solr_zk_quorum
...
logsearch_solr_collection_service_logs = logsearch_properties[
    'logsearch.solr.collection.service.logs']
logsearch_service_logs_split_interval_mins = logsearch_properties[
    'logsearch.service.logs.split.interval.mins']
logsearch_collection_service_logs_numshards = logsearch_properties[
    'logsearch.collection.service.logs.numshards']

logsearch_solr_collection_audit_logs = logsearch_properties[
    'logsearch.solr.collection.audit.logs']
logsearch_audit_logs_split_interval_mins = logsearch_properties[
    'logsearch.audit.logs.split.interval.mins']
logsearch_collection_audit_logs_numshards = logsearch_properties[
...
# logfeeder-log4j
logfeeder_log_maxfilesize = default(
    '/configurations/logfeeder-log4j/logfeeder_log_maxfilesize', 10)
logfeeder_log_maxbackupindex = default(
    '/configurations/logfeeder-log4j/logfeeder_log_maxbackupindex', 10)
logfeeder_json_log_maxfilesize = default(
    '/configurations/logfeeder-log4j/logfeeder_json_log_maxfilesize', 10)
logfeeder_json_log_maxbackupindex = default(
    '/configurations/logfeeder-log4j/logfeeder_json_log_maxbackupindex', 10)

# logfeeder-env configs
logfeeder_log_dir = config['configurations']['logfeeder-env'][
    'logfeeder_log_dir']
logfeeder_log = 'logfeeder.out'
logfeeder_max_mem = config['configurations']['logfeeder-env'][
    'logfeeder_max_mem']
solr_service_logs_enable = default(
    '/configurations/logfeeder-env/logfeeder_solr_service_logs_enable', True)
solr_audit_logs_enable = default(
    '/configurations/logfeeder-env/logfeeder_solr_audit_logs_enable', True)
logfeeder_env_content = config['configurations']['logfeeder-env']['content']
logfeeder_log4j_content = config['configurations']['logfeeder-log4j'][
    'content']

logfeeder_keystore_location = config['configurations']['logfeeder-env'][
    'logfeeder_keystore_location']
logfeeder_keystore_type = config['configurations']['logfeeder-env'][
    'logfeeder_keystore_type']
logfeeder_keystore_password = config['configurations']['logfeeder-env'][
    'logfeeder_keystore_password']
logfeeder_truststore_location = config['configurations']['logfeeder-env'][
    'logfeeder_truststore_location']
logfeeder_truststore_type = config['configurations']['logfeeder-env'][
    'logfeeder_truststore_type']
logfeeder_truststore_password = config['configurations']['logfeeder-env'][
    'logfeeder_truststore_password']

logfeeder_env_config = dict(config['configurations']['logfeeder-env'])
logfeeder_env_jceks_file = os.path.join(logsearch_logfeeder_conf,
                                        'logfeeder.jceks')

logfeeder_ambari_config_content = config['configurations'][
    'logfeeder-ambari-config']['content']
logfeeder_output_config_content = config['configurations'][
    'logfeeder-output-config']['content']
logfeeder_kafka_output_config_content = config['configurations'][
    'logfeeder-kafka-output-config']['content']

logfeeder_kafka_output_enabled = False
if 'logfeeder-kafka-output-config' in config['configurations']:
    logfeeder_kafka_output_enabled = default(
        '/configurations/logfeeder-kafka-output-config/logfeeder_kafka_output_enabled',
        False)
    logfeeder_kafka_broker_list = default(
        '/configurations/logfeeder-kafka-output-config/logfeeder_kafka_broker_list',
        'localhost:6667')
    logfeeder_kafka_topic = default(
        '/configurations/logfeeder-kafka-output-config/logfeeder_kafka_topic',
        'log-streaming')

if logfeeder_kafka_output_enabled:
    default_config_files = ','.join(
        ['output.config.json', 'global.config.json', 'kafka-output.json'])
else:
    default_config_files = ','.join(
        ['output.config.json', 'global.config.json'])

logfeeder_grok_patterns = config['configurations']['logfeeder-grok'][
...
logfeeder_properties['logfeeder.config.files'] = format(
    logfeeder_properties['logfeeder.config.files'])
logfeeder_properties[
    'logfeeder.solr.zk_connect_string'] = logsearch_solr_zk_quorum + logsearch_solr_zk_znode

logfeeder_properties['logfeeder.metrics.collector.hosts'] = format(
    logfeeder_properties['logfeeder.metrics.collector.hosts'])
logfeeder_properties[
    'logfeeder.metrics.collector.protocol'] = metrics_collector_protocol
logfeeder_properties[
    'logfeeder.metrics.collector.port'] = metrics_collector_port
logfeeder_properties[
...
logfeeder_checkpoint_folder = logfeeder_properties[
...
logsearch_acls = ''
if 'infra-solr-env' in config[
        'configurations'] and security_enabled and not logsearch_use_external_solr:
    ...
    acl_logsearch_principal = get_name_from_principal(
        config['configurations']['logsearch-env']
        ['logsearch_kerberos_principal'])
    logsearch_acls = format(
        'world:anyone:r,sasl:{acl_infra_solr_principal}:cdrwa,sasl:{acl_logsearch_principal}:cdrwa'
    )
...
smoke_logsearch_cmd = format(
    'curl -k -s -o /dev/null -w "%{{http_code}}" {logsearch_protocol}://{logsearch_server_host}:{logsearch_ui_port}/api/v1/info | grep 200'
)
