...
if config is not None:
    ...
    if configurations is not None:
        ...
        if kerberos_env is not None:
            ...
            service_check_retry_count = int(
                get_property_value(kerberos_env, 'service_check_retry_count',
                                   service_check_retry_count))
            service_check_retry_period_sec = int(
                get_property_value(kerberos_env,
        ...
        if krb5_conf_data is not None:
            ...
            manage_krb5_conf = get_property_value(krb5_conf_data,
                                                  'manage_krb5_conf', "true")
            force_tcp = get_property_value(krb5_conf_data, 'force_tcp',
                                           "false")
