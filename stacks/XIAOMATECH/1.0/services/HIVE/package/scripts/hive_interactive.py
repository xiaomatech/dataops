...
def hive_interactive(name=None):
    ...
    if not params.whs_dir_protocol or params.whs_dir_protocol == urlparse(
        ...
        params.HdfsResource(
            params.hive_metastore_warehouse_dir,
            type="directory",
  ...
  '''
    ...
    File(
        format("{hive_server_interactive_conf_dir}/hive-env.sh"),
        owner=params.hive_user,
        group=params.user_group,
        mode=0755,
    ...
    File(
        format("{hive_server_interactive_conf_dir}/{hive_log4j2_filename}"),
        mode=mode_identified,
        group=params.user_group,
        owner=params.hive_user,
    ...
    File(
        os.path.join(hive_server_interactive_conf_dir,
    ...
    File(
        ...
        mode=0644)
    File(
        params.start_hiveserver2_interactive_path,
        mode=0755,
    ...
    Directory(
        ...
        mode=0755)
    Directory(
        params.hive_interactive_var_lib,
        create_parents=True,
        cd_access='a',
        owner=params.hive_user,
        group=params.user_group,
