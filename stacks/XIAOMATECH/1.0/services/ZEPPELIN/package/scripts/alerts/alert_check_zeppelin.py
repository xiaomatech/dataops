...
def get_tokens():
  ...
  """
    return (ZEPPELIN_USER_KEY, UI_SSL_ENABLED, SECURITY_ENABLED_KEY,
            ZEPPELIN_KEYTAB_KEY, ZEPPELIN_PRINCIPAL_KEY,
            KERBEROS_EXECUTABLE_SEARCH_PATHS_KEY, ZEPPELIN_PORT_KEY,
...
def execute(configurations={}, parameters={}, host_name=None):
    ...
    if ZEPPELIN_PRINCIPAL_KEY in configurations:
        ...
        zeppelin_principal = zeppelin_principal.replace(
    ...
    try:
        ...
        return (RESULT_CODE_CRITICAL,
                ["Zeppelin is not running=" + str(command)])
