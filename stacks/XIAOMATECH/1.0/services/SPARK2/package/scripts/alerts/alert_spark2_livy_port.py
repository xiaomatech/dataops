...
def get_tokens():
    ...
    """
    return (LIVY_SERVER_HOST_KEY, LIVY_SERVER_PORT_KEY, LIVYUSER_DEFAULT,
            SECURITY_ENABLED_KEY, SMOKEUSER_KEYTAB_KEY,
            SMOKEUSER_PRINCIPAL_KEY, SMOKEUSER_KEY, LIVY_SSL_ENABLED_KEY)
...
def execute(configurations={}, parameters={}, host_name=None):
    ...
    try:
        ...
        try:
            ...
            Execute(
                livy_cmd, tries=3, try_sleep=1, logoutput=True, user=livyuser)
